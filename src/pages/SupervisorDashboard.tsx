// 🤖 [IA] - Dashboard Supervisor v4.0.0 (DACC Órdenes #1-#5b completadas)
...
// v4.0.0: hardening QA/TDD de botones de navegación y validación de filtros.
        ...
        <div className="mx-auto max-w-2xl px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-sm font-semibold text-white/90">
              ...
              <span className="ml-2 text-[10px] font-normal text-white/30">v4.0.0</span>
            </h1>
          </div>
