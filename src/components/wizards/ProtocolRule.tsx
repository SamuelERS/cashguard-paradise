    ...
    >
      ...
      {isCurrent && state.isEnabled && !state.isChecked && (
        <motion.div
          ...
          className="absolute -top-10 -right-2 bg-primary text-primary-foreground text-xs px-3 py-2 rounded-full shadow-lg z-10 min-w-max min-h-[44px] flex items-center"
          role="status"
          aria-live="polite"
