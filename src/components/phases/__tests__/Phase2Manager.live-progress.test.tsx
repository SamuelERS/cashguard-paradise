...
describe('Phase2Manager - live progress propagation', () => {
  it('propaga progreso live de entrega mediante onDeliveryCalculationUpdate', () => {
    ...
    const onStepLiveUpdate = deliverySectionPropsRef.current?.onStepLiveUpdate as
      | ((event: { stepKey: string; quantity: number; subtotal: number }) => void)
      | undefined;

    expect(onStepLiveUpdate).toBeTypeOf('function');
