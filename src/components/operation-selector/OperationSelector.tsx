// 🤖 [IA] - v4.0.0: OT11 - Caso-UX-UI-Feb-19 COMPLETADO (glass morphism, botones estandarizados, viewport-scale eliminado, style blocks 64→38)
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* 🤖 [IA] - v4.0.0: OT11 UX-Audit Feb-19 completado */}
